                                                ...
                                                <ul class="mega-menu">
                                                    <li class="mega-menu-wrap">
                                                        <ul class="mega-menu-col">
                                                            ...
                                                            <li class="active"><a href="{{ route('shop.page') }}">Our shop page</a></li>
                                                            <li><a href="#">Shop Details page </a></li>
                                                            <li class=""><a href="{{ route('cart.page') }}">Cart Page</a></li>
                                                            ...
                                                            <div class="cart-content">
                                                                ...
                                                                <div class="cart-price">
                                                                    <span class="new"> Price:
                                                                        {{ $cart->price - $cart->price * ($cart->discount / 100) }} sum
                                                                        </span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <a href="{{ route('main.show', $product->id) }}"><img src="{{ $product->image }}" width="260" height="270" alt=""></a>
                                ...
                                <div class="content">
                                    ...
                                    <span style="color: green" class="price">{{ $product->price - $product->price * ($product->discount / 100) }} so'm</span>
                                    <span style="color: red"class="price"><del>{{ $product->price }}</del> so'm<span>
                                </div>
                            </div>
                        </div>
                        @endforeach
